...
CREATE TABLE `ejercicios` (
                              ...
                              `tipo` enum('Aleatorio','Deterministico') DEFAULT NULL,
                              `variables` enum('Tres','Cuatro','Cinco') DEFAULT NULL,
...
CREATE TABLE `usuarios` (
                            ...
                            `semestre` varchar(75) DEFAULT NULL,
...
(7, 'admin', 'Administrador', 'General', 'NA', 'example@example.com', 'MX', AES_ENCRYPT('miniB001!.', '%your_password%'), 0, '', '', '', 1, '2018-09-13 10:28:11');
